class GraveyardMission extends SurvivorMissions
{
	...
	void GraveyardMission()
	{
		...
		m_MissionMessage1 = "Acabo de recibir el mensaje de que el comandante de las tropas de defensa de Chernarus, el general mayor "+ SurvivorName +" no ha sobrevivido a su infección.";
		m_MissionMessage2 = "Fue uno de los oficiales del ejército soviético en Chernarus. "+ SurvivorName +" me dijo que perdió a más de 2000 hombres aquí y que nunca dejará de luchar contra la infección mientras viva. Se infectó mientras aseguraba a los residentes de "+ m_MissionLocation +".";
		m_MissionMessage3 = "Escondió algo de equipo en el cementerio de\n** "+ m_MissionLocation +", "+ m_MissionLocationDir +" cerca de la iglesia **\nCreo que alguien debería recibir su legado. Lo enterró en algún lugar cerca de las tumbas. Necesitas al menos una pala. ¡Cuídate!";
