...
{	//CityStore is a copy of UrbanMall mission, it uses another secondary mission building
	...
	{		
		...
		m_MissionMessage1 = "Ms. "+ SurvivorName +", una maestra de escuela primaria, me dijo que había traído a algunos niños de su clase a salvo de sus familias infectadas. Le prometí que la ayudaría a conseguir alimentos y otros suministros médicos para los niños.";
		m_MissionMessage2 = "Ayer me enteré de que la tienda de la ciudad de\n** "+ m_MissionLocationDir +" de "+ m_MissionLocation +" **\ntiene barricadas y probablemente tenga algo de comida adentro. Pero había demasiados infectados, no pude revisar el supermercado.";
		m_MissionMessage3 = "Necesita urgentemente las siguientes cosas:\n- "+ ReqFoodAmount +" latas de comida..\n- "+ ReqMedAmount +" paquetes de antibióticos\nPor favor, ayúdame a apoyar a Ms. "+ SurvivorName +" con esos elementos esenciales de la vida de los niños.";
