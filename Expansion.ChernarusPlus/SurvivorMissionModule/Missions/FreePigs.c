class FreePigsMission extends SurvivorMissions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName +", un granjero de "+ m_MissionLocation +", murió hace 2 días tras un ataque de bandidos. Estaba protegiendo a sus animales de los infectados y carroñeros y estaba criando cerdos para llevar carne a los escondites de los supervivientes en algún lugar de los bosques.";
		m_MissionMessage2 = "Fue muy conocido entre los supervivientes por su perfección en la elaboración de un buen tocino y carne condimentada para barbacoa. Sus cerdos todavía están en el cobertizo y me temo que podrían morir de hambre, si no están ya muertos por infectados o robados por bandidos.";
		m_MissionMessage3 = "Ve a la granja de "+ SurvivorName +" situada en \n** "+ m_MissionLocationDir +" de "+ m_MissionLocation +" **\ny libera a todos los cerdos de su jaula para que tengan la oportunidad de sobrevivir. Necesitas al menos un cuchillo.";
