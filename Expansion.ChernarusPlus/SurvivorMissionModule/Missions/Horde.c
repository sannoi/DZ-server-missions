class HordeMission extends SurvivorMissions
{
	...
	void HordeMission()
	{
		...
		m_MissionMessage1 = "Recibí una llamada de emergencia de un piloto de helicóptero que se estrelló en algún lugar de los bosques. Está herido pero sigue vivo. Temía que los infectados lo encontraran pronto.";
		m_MissionMessage2 = "La hizo desde una casa de un pueblo cerca del lugar del accidente. Está bien equipado y cree que pasará la noche en la casa donde tratará sus heridas abiertas.";
		m_MissionMessage3 = "La casa está en el ** "+ m_MissionLocationDir +" cerca de "+ m_MissionLocation +" **\n¡Ten cuidado ya que puede haber infectados y otros supervivientes que quieran su equipo!";
