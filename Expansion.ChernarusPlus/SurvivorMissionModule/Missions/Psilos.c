class PsilosMission extends SurvivorMissions
{
	...
	{	
		...
		m_MissionMessage1 = SurvivorName +", un superviviente que conocí hace unos días me dijo que hay algunos lugares por aquí con numerosas apariciones de un hongo especial. Su nombre de clasificación es 'Psilocybe semilanceata'.";
		m_MissionMessage2 = "En este momento estoy experimentando con el ingrediente psicoactivo Psilocibina en animales salvajes infectados. Los animales muestran comportamientos interesantes después de 30 minutos de la ingesta oral. Todavía no puedo decir mucho al respecto, pero para mis experimentos necesito más hongos.";
		m_MissionMessage3 = SurvivorName +" dijo que encontró algunos cerca de\n** "+ m_MissionLocationDir +" de "+ m_MissionLocation +" **\nNecesito "+ ReqShroomsCount +" piezas más. Las setas son muy pequeñas. ¡Recomiendo usar una enciclopedia de hongos para posibles ocurrencias!";
