class ApartmentMission extends SurvivorMissions
{
	...
	void ApartmentMission()
	{
		...
		//Mission messages 
        m_MissionMessage1 = SurvivorName +" fue uno de mis mejores estudiantes. Solía hablar con él por radio, pero ahora he perdido el contacto con él.";
        m_MissionMessage2 = "Me dijo que había escondido un baúl con buen equipo en algún lugar de los apartamentos. Hace unos días puso barricadas en todo el edificio contra los infectados.";
        m_MissionMessage3 = "Solía vivir en uno de los apartamentos\n** "+ m_MissionLocationDir +" de "+ m_MissionLocation+" **\nComprueba si "+SurvivorName+" sigue vivo. Si no es así, llévate sus cosas para ayudarte a sobrevivir.";
