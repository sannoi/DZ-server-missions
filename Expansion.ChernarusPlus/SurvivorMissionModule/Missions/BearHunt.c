class BearHuntMission extends SurvivorMissions
{
	...
	{	
		...
		m_MissionMessage1 = "Un superviviente me informó recientemente que un oso atacó a mi amigo "+ SurvivorName +" y mató a otros 2 sobrevivientes. Fueron al lugar equivocado tratando de cazar algunos ciervos en el bosque de "+ m_MissionLocation +".";
		m_MissionMessage2 = "Todavía no lo puedo creer. "+ SurvivorName +" era uno de los mejores cazadores por aquí. Una vez a la semana traía carne fresca al campamento escondido para alimentar a los sobrevivientes. Nunca fue desinteresado y trató de hacer todo lo posible para ayudar en el campamento.";
		m_MissionMessage3 = "El oso fue visto por última vez en el bosque cerca\n** "+ m_MissionLocationDir +" de "+ m_MissionLocation +" **\nQuiero que mates a este animal y le quites la piel. No es por venganza, solo necesitamos la piel para hacer ropa de invierno para los niños. ¡Ten cuidado!";
