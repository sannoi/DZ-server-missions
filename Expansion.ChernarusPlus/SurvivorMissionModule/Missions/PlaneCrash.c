class PlaneCrashMission extends SurvivorMissions
{
	...
	void PlaneCrashMission()
	{
        ...
        m_MissionMessage1 = "Acabo de recibir una llamada de emergencia de un piloto militar. Un miembro de la tripulación se infectó y de repente atacó a los otros. Dijo que este vuelo tiene la máxima prioridad internacional.";
        m_MissionMessage2 = "También a bordo está el Sr. "+ SurvivorName +", es un agente de la ONU y parece que tiene alguna información sobre la cura para esta pandemia. Estaban en el nivel de vuelo 300 de camino a Gales.";
        m_MissionMessage3 = "El piloto dijo que fue mordido e intentó aterrizar de emergencia en algún lugar de los campos\n** "+ m_MissionLocationDir +" de "+ m_MissionLocation +" **\nDescubre si lo lograron. ¡Tienen algo de equipo a bordo!";		
