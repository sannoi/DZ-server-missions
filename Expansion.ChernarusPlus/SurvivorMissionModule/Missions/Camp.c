class CampMission extends SurvivorMissions
{
	...
	void CampMission()
	{
        ...
        m_MissionMessage1 = "Mi amigo "+ SurvivorName +" no ha respondido por radio en las últimas 2 horas. Es un excelente sobreviviente al aire libre y me pregunto si está bien.";
        m_MissionMessage2 = "Su hija está infectada, él la cuida a veces. Hace unas 5 horas, me dijo que había encontrado cosas en algunas casas de "+ m_MissionLocation +" y fue atacado en el camino de regreso a su campamento, pero no resultó herido.";
        m_MissionMessage3 = "Creo que dijo que recientemente instaló su tienda\n "+ m_MissionLocationDir +" de "+ m_MissionLocation +" \nEstoy muy preocupado, te agradecería mucho que pudieras ir a cuidarlo. ¡Cuidado, usa trampas para proteger su lugar!";		
